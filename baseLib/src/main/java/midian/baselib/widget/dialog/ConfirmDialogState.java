...
public class ConfirmDialogState extends Dialog {
	...
	public ConfirmDialogState(Context context, boolean cancelable,
			OnCancelListener cancelListener) {
		super(context, cancelable, cancelListener);
		init(context);
	}

	public ConfirmDialogState(Context context, int theme) {
		super(context, theme);
		init(context);
	}

	public ConfirmDialogState(Context context) {
		super(context);
		init(context);
	}
	...
	private void init(Context context) {
		...
		contentView = View.inflate(context, R.layout.dp_confirm_state_dialog, null);
	...
	public ConfirmDialogState setTitleText(String title) {
		title_tv.setText(title);
		return this;
	}

	public ConfirmDialogState setTitleText(int resId) {
		title_tv.setText(resId);
		return this;
	}

	public ConfirmDialogState setMessageText(String message) {
		message_tv.setText(message);
		return this;
	}

	public ConfirmDialogState setMessageText(int resId) {
		message_tv.setText(resId);
		return this;
	}

	public ConfirmDialogState setRight(String right,
			View.OnClickListener onClickListener) {
	...
	public ConfirmDialogState setRight(int resId,
			View.OnClickListener onClickListener) {
	...
	public ConfirmDialogState toggleInput(boolean isShown) {
		if (isShown) {
	...
	public ConfirmDialogState config(String title, String message, String right,
	...
	public ConfirmDialogState config(int titleResId, int messageResId,
	...
	public ConfirmDialogState config(String title, String message,
	...
	public ConfirmDialogState configForCouseDialog(String title, String message,
	...
	public static void makeText(Context mContext, String title, String content,
		...
		final ConfirmDialogState dialog = new ConfirmDialogState(mContext,
				R.style.confirm_dialog);
		dialog.config(mContext.getString(R.string.warm_state), content,
				rightText, rightOnClickListener);
		dialog.show();
	}

	public static void makeText1(Context mContext, String title, String content,
			String rightText, View.OnClickListener rightOnClickListener) {
		final ConfirmDialogState dialog = new ConfirmDialogState(mContext,
				R.style.confirm_dialog);
		dialog.config(mContext.getString(R.string.warm_state_chaoqi), content,
				rightText, rightOnClickListener);
		dialog.show();
	}
