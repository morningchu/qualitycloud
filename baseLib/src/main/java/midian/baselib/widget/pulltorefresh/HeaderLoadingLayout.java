...
public class HeaderLoadingLayout extends LoadingLayout {
	...
	private void init(Context context) {
		...
		progressContent = findViewById(R.id.pull_to_refresh_header_progressbar_content);
		tip = (TextView) findViewById(R.id.pull_to_refresh_header_progressbar_hint_textview);
