...
import midian.baselib.widget.pulltorefresh.ILoadingLayout.State;
 ...
 * @since 2013-8-15
 */
public class PullToRefreshGridView extends PullToRefreshBase<HeaderFooterGridView> implements OnScrollListener {
	...
	@Override
	protected HeaderFooterGridView createRefreshableView(Context context, AttributeSet attrs) {
		HeaderFooterGridView gridView = new HeaderFooterGridView(context);
		mGridView = gridView;
