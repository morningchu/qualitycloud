package com.midian.fastdevelop.afinal;
...
import com.midian.fastdevelop.afinal.http.RetryHandler;
import com.midian.fastdevelop.afinal.http.SyncRequestHandler;
...
public class FinalHttp {
	...
	// ------------------get 请求-----------------------
	public <T> HttpHandler<T> get(String url, AjaxCallBack<? extends Object> callBack) {
		return get(url, null, callBack);
	}

	public <T> HttpHandler<T> get(String url, AjaxParams params, AjaxCallBack<? extends Object> callBack) {
		return sendRequest(httpClient, httpContext, new HttpGet(getUrlWithQueryString(url, params)), null, callBack,null);
	}

	public <T> HttpHandler<T> get(String url, Header[] headers, AjaxParams params, AjaxCallBack<? extends Object> callBack) {
		HttpUriRequest request = new HttpGet(getUrlWithQueryString(url, params));
		if (headers != null)
			request.setHeaders(headers);
		return sendRequest(httpClient, httpContext, request, null, callBack,null);
	}
	...
	// ------------------post 请求-----------------------
	public <T> HttpHandler<T> post(String url, AjaxCallBack<? extends Object> callBack,String requestTag) {
		return post(url, null, callBack,requestTag);
	}

	public <T> HttpHandler<T> post(String url, AjaxParams params, AjaxCallBack<? extends Object> callBack,String requestTag) {
		return post(url, paramsToEntity(params), null, callBack,requestTag);
	}

	public <T> HttpHandler<T> post(String url, HttpEntity entity, String contentType, AjaxCallBack<? extends Object> callBack,String requestTag) {
		return sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpPost(url), entity), contentType, callBack,requestTag);
	}
	...
	public <T> void post(String url, Header[] headers, AjaxParams params, String contentType, AjaxCallBack<T> callBack) {
		...
		if (headers != null)
			request.setHeaders(headers);
		sendRequest(httpClient, httpContext, request, contentType, callBack,null);
	}
	...
	public AsyncTask<Object, Object, Object> put(String url, AjaxCallBack<? extends Object> callBack) {
		return put(url, null, callBack);
	}

	public AsyncTask<Object, Object, Object> put(String url, AjaxParams params, AjaxCallBack<? extends Object> callBack) {
		return put(url, paramsToEntity(params), null, callBack);
	}

	public AsyncTask<Object, Object, Object> put(String url, HttpEntity entity, String contentType, AjaxCallBack<? extends Object> callBack) {
		return sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpPut(url), entity), contentType, callBack);
	}
	...
	public HttpHandler<File> download(String url, String target, AjaxCallBack<File> callback) {
		return download(url, null, target, false, callback,false);
	}

	public HttpHandler<File> download(String url, String target, boolean isResume, AjaxCallBack<File> callback) {
		return download(url, null, target, isResume, callback,false);
	}

	public HttpHandler<File> download(String url, AjaxParams params, String target, AjaxCallBack<File> callback) {
		return download(url, params, target, false, callback,false);
	}

	public HttpHandler<File> download(String url, AjaxParams params, String target, boolean isResume, AjaxCallBack<File> callback,boolean isMidianBreakpoint) {
		if(isMidianBreakpoint){			
		...
		HttpHandler<File> handler = new HttpHandler<File>(httpClient, httpContext, callback, charset,null);
		handler.executeOnExecutor(executor, get, target, isResume);
		return handler;
	}

	@SuppressWarnings("rawtypes")
	protected <T> HttpHandler sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType,
			AjaxCallBack<T> ajaxCallBack) {
		return sendRequest(client, httpContext, uriRequest, contentType, ajaxCallBack,null);
	}
	@SuppressWarnings("rawtypes")
	protected <T> HttpHandler sendRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType,
			AjaxCallBack<T> ajaxCallBack,String requestTag) {
		if (contentType != null) {
			uriRequest.addHeader("Content-Type", contentType);
		}
		HttpHandler handler = new HttpHandler<T>(client, httpContext, ajaxCallBack, charset,requestTag);
