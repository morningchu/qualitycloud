...
import com.midian.fastdevelop.afinal.bitmap.core.BytesBufferPool.BytesBuffer;
import com.midian.fastdevelop.afinal.bitmap.core.DiskCache.LookupRequest;
...
public class BitmapCache {
    ...
    //默认的磁盘缓存大小
    private static final int DEFAULT_DISK_CACHE_SIZE = 1024 * 1024 * 500; // 500MB
