package com.midian.fastdevelop.afinal.utils;
...
import com.midian.fastdevelop.afinal.db.table.Property;
		...
		try {
			...
			for (Field f : fs) {
				if (!FieldUtils.isTransient(f) && FieldUtils.isOneToMany(f)) {
					...
					com.midian.fastdevelop.afinal.annotation.sqlite.OneToMany oneToMany = f.getAnnotation(com.midian.fastdevelop.afinal.annotation.sqlite.OneToMany.class);
